#!/usr/bin/env python3
# -*- encoding: utf-8 -*-
# File: osc4py3/tests/udpmc.py
# <pep8 compliant>
"""This file can be used as a start point for multicast usage.
...
# Specify a multicast group address (see UdpMcChannel doc).
IP = "224.3.29.71"
PORT = 10000    # Hope it is not used.
...
#TODO: Write high level test code with as_xxx functions for multicast client/server.
