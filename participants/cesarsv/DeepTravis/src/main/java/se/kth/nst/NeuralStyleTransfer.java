...
public class NeuralStyleTransfer {
    ...
    private static final String CONTENT_FILE = "styletransfer/travis-logo.jpg";
    private static final String STYLE_FILE = "styletransfer/style-2.jpg";
    ...
    private BufferedImage saveImage(INDArray combination, int iteration) throws IOException {
        ...
        File file = new File("/home/cesarsv/Documents/codes/github_repos/convolutional-travis/src/main/resources/styletransfer/out" + "/iteration" + iteration + ".jpg");
