...
LIGTHS_MAP = {'1' : initLightMap(2, [0, 1, 0]),
                ...
                '15' : initLightMap(32, [1, 1, 0.75]),
                '16' : initLightMap(35, [1, 1, 0.75]),
                '17' : initLightMap(38, [1, 1, 0.75]),
                '18' : initLightMap(41, [1, 1, 0.75]),
                '19' : initLightMap(44, [1, 1, 0.75]),
                '20' : initLightMap(47, [1, 1, 0.75]),
                '21' : initLightMap(50, [1, 1, 0.75]),
                '22' : initLightMap(53, [1, 1, 0.75]),
                '23' : initLightMap(56, [1, 1, 0.75]),
                '24' : initLightMap(59, [1, 1, 0.75]),
                '25' : initLightMap(62, [1, 1, 0.75]),
                '26' : initLightMap(65, [1, 1, 0.75]),
             }
