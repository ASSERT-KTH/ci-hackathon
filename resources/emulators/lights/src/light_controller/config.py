...
LIGTHS_MAP = {  '1' : initLightMap(2,   [0, 0.1, 0]),
                ...
                '12' : initLightMap(20,  [0, 0.3, 0]) ,
                '11' : initLightMap(23,  [0.2, 0.3, 0]) ,
                '10' : initLightMap(26,  [0.4, 0.3, 0]),
                '9' : initLightMap(29, [0.6, 0.3, 0]),
                '8' : initLightMap(32, [0.8, 0.3, 0]),
                '7' : initLightMap(35, [1, 0.3, 0]),
                ...
                '24' : initLightMap(56, [0, 0.7, 0]),
                '23' : initLightMap(59, [0.2, 0.7, 0]),
                '22' : initLightMap(62, [0.4, 0.7, 0]),
                '21' : initLightMap(65, [0.6, 0.7, 0]),
                '20' : initLightMap(68, [0.8, 0.7, 0]),
                '19' : initLightMap(72, [1, 0.7, 0]),
             }
